...
BODY = r'''
  ...
  <h3>TDSR counts your existing mortgage</h3>

  <p><strong>TDSR</strong> caps total monthly debt obligations at <strong>55% of gross monthly income</strong>. It applies to every property loan, regardless of how many properties you own.</p>

  <p>The part that surprises people is the rate used. Both your existing and your new housing loan are computed at a <strong>medium-term interest rate floor of 4% per annum</strong> for residential property. That is not the rate you actually pay. If your first mortgage sits on a 1.4% package, it is still stress-tested at 4% when the second loan is sized.</p>

  <h3>MSR usually does not apply</h3>

  <p><strong>MSR</strong>, the 30% cap on housing instalments alone, applies <em>only</em> to HDB flats and to executive condominiums still within their minimum occupation period. It does not apply to private property, nor to a post-MOP EC. Most second-property purchases are private, so TDSR is usually the binding constraint.</p>
  ...
  <p>ABSD is charged on the higher of purchase price or market value. Buyer's Stamp Duty is payable on top. BSD can be reimbursed from CPF after the fact; ABSD has to stay cash unless a remission applies.</p>

  <p>Married couples with at least one Singapore Citizen should read the <a href="../avoid-absd-second-property-singapore/">remission and restructuring routes</a> before committing. That decision is far easier to make before the first purchase than after.</p>
  ...
  <table>
    ...
    <tbody>
      ...
      <tr><td>of which cash (25%, CPF not allowed)</td><td>S$375,000</td></tr>
      <tr><td>balance (30%, cash or CPF OA)</td><td>S$450,000</td></tr>
  ...
  <p>Nearly S$720,000 in cash before CPF contributes anything, on a S$1.5M purchase.</p>

  <p>Now change one variable. Had this buyer been 45 rather than 40, on the same 25-year tenure, the loan would have dropped to the 25% tier. That is a maximum loan of S$375,000, so a further S$300,000 to find, for five years of age.</p>
  ...
  <p>Between those two routes and the decoupling option, there is usually more than one way to structure a second purchase. Which one is cheapest depends on your ages, your CPF balances and how much of the first mortgage is left. Ordering matters too: some doors close once the purchase is made.</p>
  ...
  <p style="font-size: .8rem; color: rgba(232,227,218,.35); line-height: 1.6;">
    ...
    and the actual amount depends on the exact consideration and IRAS calculation. Rules change, so confirm

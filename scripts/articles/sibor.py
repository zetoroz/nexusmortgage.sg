...
BODY = r'''
  ...
  <p>The transition was not sudden. It ran for years under the Steering Committee for SOR &amp; SIBOR Transition to SORA (SC-STS), convened by MAS together with the Association of Banks in Singapore. SC-STS published its final conversion approach on <strong>30 June 2023</strong>. The remaining loans were then converted automatically in <strong>June 2024</strong>, well before the benchmark stopped publishing.</p>
  ...
  <p>Under the industry package, the switch to the SCP carried <strong>no conversion fee and no new lock-in period</strong>. Any existing lock-in simply continued to run, and subsidy clawback periods carried over rather than resetting.</p>
  ...
  <h3>Two methods, depending on when you converted</h3>

  <p>During the active transition window the spread was a <em>spot</em> figure: the average gap between SIBOR and compounded SORA over the preceding three months, floored at zero. ABS Co republished it on the first business day of each month.</p>

  <p>At automatic conversion in June 2024 a different method applied. The spread there was the <strong>historical median over the five years from 30 June 2018 to 30 June 2023</strong>.</p>
